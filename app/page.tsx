  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (ausDatum && /\d{1,2}[\.\-]\d{2}[\.\-]\d{4}/.test(ausDatum) && ausBetrag !== null && ausBetrag < 0) {
      ...
      const autoKat = !rawKat ? (
        ...
        n.includes("finanzamt") || n.includes("kfz-steuer") || n.includes("federal tax authority") || (n.includes("steuer") && !n.includes("rückerstattung")) ? "Steuer" :
        ...
        n.includes("db vertrieb") || n.includes("deutsche bahn") || n.includes("db bahn") || n.includes("booking.com") || n.includes("hotel") || n.includes("taxi") || n.includes("restaurant") ? "Reisekosten" :
        ...
        n.includes("hp venius") || n.includes("stefan michalea") || n.includes("skalator") || n.includes("pineapple") || n.includes("moritz winter") || n.includes("dienstleist") ? "Dienstleistung" :
