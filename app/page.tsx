  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (ausDatum && /\d{1,2}[\.\-]\d{2}[\.\-]\d{4}/.test(ausDatum) && ausBetrag !== null && ausBetrag < 0) {
      ...
      const autoKat = !rawKat ? (
        ...
        n.includes("finanzamt") || n.includes("kfz-steuer") || n.includes("federal tax authority") || (n.includes("steuer") && !n.includes("rückerstattung") && !n.includes("digital tax")) ? "Steuer" :
        ...
        n.includes("versicherung") || n.includes("markel") || n.includes("insurance") ? "Versicherung" :
        n.includes("db vertrieb") || n.includes("deutsche bahn") || n.includes("db bahn") || n.includes("booking.com") || n.includes("hotel at booking") || n.includes("partners on booking") || n.includes("hotel") || n.includes("restaurant") || n.includes("rückerstattung") ? "Reisekosten" :
