  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (ausDatum && /\d{1,2}[\.\-]\d{2}[\.\-]\d{4}/.test(ausDatum) && ausBetrag !== null && ausBetrag < 0) {
      ...
      const autoKat = !rawKat ? (
        ...
        n.includes("versicherung") || n.includes("markel") || n.includes("allianz") || n.includes("arag") ? "Versicherung" :
        n.includes("db vertrieb") || n.includes("deutsche bahn") || n.includes("db bahn") || n.includes("booking") || n.includes("hotel") || n.includes("taxi") || n.includes("restaurant") || n.includes("rückerstattung") || n.includes("stadtmauer") ? "Reisekosten" :
        n.includes("telekom") || n.includes("vodafone") || n.includes("mobilfunk") ? "Telekommunikation" :
        n.includes("tankstelle") || n.includes("aral") || n.includes("hem ") || n.includes("sb-tank") || n.includes("tank ") ? "Tankstelle" :
        n.includes("claude") || n.includes("software") || n.includes("google workspace") || n.includes("google cloud") || n.includes("google_cloud") || n.includes("pixelflow") || n.includes("stitch") || n.includes("zoom") || n.includes("slack") || n.includes("close crm") || n.includes("atlassian") || n.includes("webflow") || n.includes("hostinger") || n.includes("zapier") || n.includes("monday") || n.includes("vimeo") || n.includes("calendly") || n.includes("ionos") || n.includes("anthropic") || n.includes("recruitee") || n.includes("jotform") || n.includes("jumpshare") || n.includes("cookiebot") || n.includes("stitchdata") || n.includes("figma") || n.includes("airtable") || n.includes("openai") || n.includes("perplexity") || n.includes("lovable") || n.includes("manus") || n.includes("n8n") || n.includes("onecal") || n.includes("easybill") ? "Software" :
